...
const Signup = () => {
  ...
  const Save = async (e) => {
    ...
    await apiPost(
      ...
      //         'Content-Type': 'application/json'}})
      .then((data) => {
        if (data.data.status == 404) toast.error(data.data.msg);
          ...
          <form className="form-horizontal" onSubmit={Save}>
            <fieldset>
              ...
              <div className="control-group">
                <label className={styleSignup.label}>User Name</label>
              ...
              <div className="control-group">
                <label className={styleSignup.label}>Email</label>
                <div className="controls">
                  <input
                    id="email"
                    name="email"
              ...
              {/* Text input*/}
              <div>
                <label className={styleSignup.label}>Phone Number</label>
                <div className="controls">
                  <input
                    id="phone_number"
                    name="phone_number"
              ...
              {/* Text input*/}
              <div className="control-group">
                <label className={styleSignup.label}>Address</label>
                <div className="controls">
                  <input
                    id="address"
                    name="address"
              ...
              {/* Text input*/}
              <div className="control-group">
                <label className={styleSignup.label}>Password</label>
                <div className="controls">
                  <input
                    id="password"
                    name="password"
