...
import statementStyle from "../pages/statements/statement.module.css"
...
const Statement = () => {
    ...
    const getMonthlyStatement = async () => {
        await axios.get(`http://localhost:5000/monthly-statement/get-statement/${localStorage.getItem('mess_id')}`, {
            headers: {
